...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rio-viz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14330&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rio-viz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rio-viz` can be installed with:

```
conda install rio-viz
```

It is possible to list all of the versions of `rio-viz` available on your platform with:
